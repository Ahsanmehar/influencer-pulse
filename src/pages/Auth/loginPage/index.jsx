    ...
    <>
      ...
      <section className="">
        <div className="container w-full px-4 ">
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-one p-7">
            <div className="text-center mb-11">
              <h2 className="font-semibold text-heading-5 text-secondary mb-1.5">
                Sign In to Your Account
              </h2>
              <p className="text-text">Enter your detail below</p>
            </div>
            ...
            <form>
              <div className="mb-5">
                <label
                  htmlFor="email"
                  className="text-text block mb-2.5 font-medium"
                >
                  Email
                </label>
                <Input
              ...
              <a
                href="#"
                className="block text-center text-secondary mt-4 ease-out duration-200 hover:text-primary"
              >
                Forget your password?
              </a>
              <span className="relative z-1 block font-medium text-center mt-4">
                <span className="block absolute z-[-1] left-0 top-1/2 h-px w-full bg-gray"></span>
                <span className="inline-block px-3 text-text bg-white">
                  Or
                </span>
              </span>
